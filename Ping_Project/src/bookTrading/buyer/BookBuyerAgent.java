	  ...
	  **/
	  ...
	  private class PurchaseManager extends TickerBehaviour {
	    ...
	    private PurchaseManager(Agent a, String t, int mp, Date d) {
	      super(a, 2000); // tick every second 
	      title = t;
	      maxPrice = mp;
	      deadline = d.getTime();
	  ...
	  public class BookNegotiator extends ContractNetInitiator {
	    ...
	    protected Vector prepareCfps(ACLMessage cfp) {
	      ...
	      if (sellerAgents.size() > 0)
	         myGui.notifyUser("Sent Call for Proposal for" + title + " to "+sellerAgents.size()+" sellers.");
	      return v;
	    }
...
//	        myGui.notifyUser("Proposal has been accepted from: " + myAgent.getLocalName());
//	        System.out.println("Proposal has been accepted from: " + myAgent.getLocalName());
	    ...
	    protected void handleInform(ACLMessage inform) {
	      ...
	      myGui.notifyUser("Service "+title+" successfully purchased @: " + price + " from Seller: " + inform.getSender());
	      manager.stop();
	    }
